...
import cardData from '../data/cardData.json'; // import the JSON file
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <p className="mt-4">
        ...
        the set. Separate each entry by a newline.
      </p>
      <p className="mb-4 italic max-w-fit">
        Example: Blue-Eyes White Dragon LOB-001 OR Blue-Eyes White Dragon The Legend of Blue Eyes White Dragon
      </p>
      <textarea
