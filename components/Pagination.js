  ...
  return (
    <div className="my-2 mx-auto w-full flex items-center justify-between border-t border-gray-200 bg-transparent backdrop filter px-4 py-3 sm:px-6">
      <div className="flex flex-1 justify-between sm:hidden">
        <button onClick={() => handlePageClick( currentPage-1 )} disabled={currentPage===1} scroll={false}>
          <a
            href="#"
        ...
        <button onClick={() => handlePageClick( currentPage+1 )} disabled={currentPage===totalPages} scroll={false}>
          <a
            href="#"
